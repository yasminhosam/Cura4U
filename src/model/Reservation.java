...
public class Reservation {
    ...
    public void dispalyReservation(){
        ...
        System.out.println("model.Patient : "+patient.getName()+",model.Doctor :"+doctor.getName()+", Slot :"+dateTime);
    }
    //toString()
    @Override
    ...
    public static boolean checkAvailability(int doctorId,LocalDateTime dateTime) {
        ...
        Doctor doctor = Doctor.getDoctorById(doctorId);
        if (doctor == null) {
            System.out.println("Error: model.Doctor not found.");
            return false;
        }
    ...
    public static Reservation createReservation(int patientId, int doctorId,LocalDateTime dateTime) {
        if(checkAvailability(doctorId,dateTime)){
            ...
            System.out.println("model.Reservation created successfully");
            return r;
        }
        else {
            System.out.println("model.Reservation creation failed");
            return null;
        }
    }
